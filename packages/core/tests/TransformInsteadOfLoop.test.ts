...
describe("TransformInsteadOfLoop", () => {
  ...
  const fixed_uri = path.join(
    __dirname,
    "../../../assets/example-flows/force-app/main/default/flows/testing/Transform_Pattern_Fixed.flow-meta.xml"
  );
  ...
  it("should not flag when using transform instead of loop", async () => {

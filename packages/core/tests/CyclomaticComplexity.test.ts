...
describe("CyclomaticComplexity ", () => {
  const example_uri = path.join(__dirname, "../../../example-flows/force-app/main/default/flows/demo/Cyclomatic_Complexity.flow-meta.xml");
  const other_uri = path.join(__dirname, "../../../example-flows/force-app/main/default/flows/demo/SOQL_Query_In_A_Loop.flow-meta.xml");
  const defaultConfig = {
    ruleMode: "isolated",
    rules: {

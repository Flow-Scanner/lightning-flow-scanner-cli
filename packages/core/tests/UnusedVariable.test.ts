...
describe("UnusedVariable Rule", () => {
  const example_uri = path.join(__dirname, "../../../example-flows/force-app/main/default/flows/demo/Unused_Variable.flow-meta.xml");
  const fixed_uri = path.join(__dirname, "../../../example-flows/force-app/main/default/flows/testing/Unused_Variable_Fixed.flow-meta.xml");

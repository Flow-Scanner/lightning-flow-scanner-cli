...
| **Core Library** (Node.js + Browser)| Custom tools, scripts, extensions, web apps   | [Flow-Scanner/lightning-flow-scanner-core](https://github.com/Flow-Scanner/lightning-flow-scanner-core) | `npm install @flow-scanner/lightning-flow-scanner-core`                        |
| **GitHub Action**                   | Native PR checks (no CLI needed)              | [Flow-Scanner/lightning-flow-scanner-action](https://github.com/Flow-Scanner/lightning-flow-scanner-action) | `uses: Flow-Scanner/lightning-flow-scanner-action@v2.2.0`                         |
...
| **In-App Scanner**                  | Run scans directly inside any Salesforce org  | [Flow-Scanner/lightning-flow-scanner-app](https://github.com/Flow-Scanner/lightning-flow-scanner-app)     | AppExchange (coming soon?)                    |
| **Copado Plugin**                   | Copado CI/CD pipelines                        | [Flow-Scanner/lightning-flow-scanner-copado](https://github.com/Flow-Scanner/lightning-flow-scanner-copado) | Available in [Copado marketplace](https://success.copado.com/s/listing-detail?language=en_US&recordId=a54P7000003G3gBIAS)                                               |
